     ...
     <form action="{{route('update.mvo')}}" method='POST' enctype="multipart/form-data" class="mt-3">
        ...
        @method('PUT')
          <div class="form-group">
            ...
            <textarea name="text" id='editor' cols="30" rows="5" class="form-control">{{$mvo->text}}</textarea>
          </div>
          <div class="row">
            <div class="col-md-5">
              <div class="form-group">
            ...
            <div class="col-md-5">
              <div class="form-group">
                @if($mvo->image)
                  ...
                  <img src="/storage/about/{{$mvo->image??''}}" alt="No Image" height='70px'> <br> <br>
