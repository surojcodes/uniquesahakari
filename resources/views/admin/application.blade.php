					...
					<div id="regularSaving" class="border p-3 mt-2 {{$application->saving_scheme!='regularSaving'?'d-none':''}}">
						<div class="row">
							<div class="col-md-6">
								<input
									type="radio"
                  {{$application->regular_option=='daily-child'?'checked':'disabled'}}
								/>
							...
							<div class="col-md-6">
								<input
									type="radio"
                  {{$application->regular_option=='monthly-child'?'checked':'disabled'}}
								/>
						...
						<div class="row">
							<div class="col-md-6">
								<input
									type="radio"
                  {{$application->regular_option=='daily'?'checked':'disabled'}}
							...
							<div class="col-md-6">
								<input
									type="radio"
                  {{$application->regular_option=='periodic'?'checked':'disabled'}}
								/>
						...
						<div class="row">
							<div class="col-md-6">
								<input
									type="radio"
                  {{$application->regular_option=='pension'?'checked':'disabled'}}
								/>
							...
							<div class="col-md-6">
								<input
									type="radio"
                  {{$application->regular_option=='share'?'checked':'disabled'}}
								/>
